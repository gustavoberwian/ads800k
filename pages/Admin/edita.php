...
$consulta_usuarios = "SELECT * FROM usuario WHERE id = {$id}";
$con = $conexao->query($consulta_usuarios) or die($conexao->error);
while ($dado = $con->fetch_array()){
?>

<div class="nHeader">
    <div class="logo">EDIÇÃO DE USUÁRIO</div>
</div>
...
<form action="./editar.php?id=<?=$id ?>" method="post">
    <div class="container">
        <div class="cadBox" style="justify-content: center">
            <div class="forms">
                <label for="nome"></label><input placeholder="<?=$dado['nome'] ?>" type="text" name="nome" id="nome">
                <label for="usuario"></label><input placeholder="<?=$dado['usuario'] ?>" type="text" name="usuario" id="usuario">
                <label for="email"></label><input placeholder="<?=$dado['email'] ?>" type="email" name="email" id="email">
                <label for="senha"></label><input placeholder="Nova senha" type="password" name="senha" id="senha">
                <label for="nivel"></label>
                <select id="nivel" name="nivel">
                    <option value="undefined">Alterar permissão de <?=$dado['usuario'] ?></option>
