...
<div class="main_container">
    <main class="cards">
        <section class="card contact">
            ...
            <span>Altere o sub domínio do seu link aqui</span>
        ...
        <section class="card shop">
            ...
            <h3>Duplicar</h3>
            <span>Duplique o seu site em outro link aqui</span>
        ...
        <section class="card about">
            ...
            <h3>Novo Dominio</h3>
            <span>Crie um link com domínio novo aqui</span>
    ...
    <main class="cards">
        <section class="card shop">
            ...
            <span>Substitua o ADV do seu link aqui</span>
        ...
        <section class="card about">
            ...
            <h3>Alterar Pré</h3>
            <span>Adicione/Altere o pré do seu link aqui</span>
